...
>>>>>>> to_mendieta
    ...
    def forward(self, x1: torch.Tensor, x2: torch.Tensor) -> \
        ...
        # UNet on x1
        enc1_1 = self.encoder1(x1) #3x256 -> 16x256
        enc1_1 = self.pool1(enc1_1) #16x256 -> 16x128
        
        enc2_1 = self.encoder2(enc1_1) #16x128 -> 32x128
        enc2_1 = self.pool2(enc2_1) # 32x128 -> 32x64
        
        enc3_1 = self.encoder3(enc2_1) #32x64 -> 64x64
        enc3_1 = self.pool3(enc3_1) #64x64 -> 64x32
        
        enc4_1 = self.encoder4(enc4_1) #64x32 -> 128x32
        enc4_1 = self.pool4(enc4_1) #128x32-> 128x16

        bottleneck_1 = self.bottleneck(enc4_1) #128x16 -> 256x16

        dec4_1 = self.upconv4(bottleneck_1) #256x16 -> 128x32
...
=======
        ...
        dec2_1 = self.upconv2(dec3_1) #64x64 -> 32x128
        dec2_1 = torch.cat((dec2_1, enc2_1), dim=1) #32x128 -> 64x128
        dec2_1 = self.decoder2(dec2_1) #64x128 -> 32x128
...
>>>>>>> to_mendieta
        ...
        # UNet on x2
        enc1_2 = self.encoder1(x2) #3x256 -> 16x256
        enc1_2 = self.pool1(enc1_2) #16x256 -> 16x128
        
        enc2_2 = self.encoder2(enc1_2) #16x128 -> 32x128
        enc2_2 = self.pool2(enc2_2) # 32x128 -> 32x64
        
        enc3_2 = self.encoder3(enc2_2) #32x64 -> 64x64
        enc3_2 = self.pool3(enc3_2) #64x64 -> 64x32
        
        enc4_2 = self.encoder4(enc4_2) #64x32 -> 128x32
        enc4_2 = self.pool4(enc4_2) #128x32-> 128x16

        bottleneck_2 = self.bottleneck(enc4_2) #128x16 -> 256x16

        dec4_2 = self.upconv4(bottleneck_2) #256x16 -> 128x32
        dec4_2 = torch.cat((dec4_2, enc4_2), dim=1) #128x32 -> 256x32 
        dec4_2 = self.decoder4(dec4_2) #256x32 -> 128x32

        dec3_2 = self.upconv3(dec4_2) #128x32 -> 64x64
        dec3_2 = torch.cat((dec3_2, enc3_2), dim=1) #64x64 -> 128x64
        dec3_2 = self.decoder3(dec3_2) #128x64 -> 64x64
        
        dec2_2 = self.upconv2(dec3_2) #64x64 -> 32x128
        dec2_2 = torch.cat((dec2_2, enc2_2), dim=1) #32x128 -> 64x128
        dec2_2 = self.decoder2(dec2_2) #64x128 -> 32x128
        
        dec1_2 = self.upconv1(dec2_2) #32x128 -> 16x256
        dec1_2 = torch.cat((dec1_2, enc1_2), dim=1) #16x256 -> 32x256
        dec1_2 = self.decoder1(dec1_2)  #32x256 -> 16x256
